...
public class SequentialSearch {
    public static void main (String[] args) {
        ...
        int target = 4;
        sequantialSearch(exampleVariableOne, target); 
    }
    public static void sequantialSearch(int[] parameterOne, int parameterTwo) {
        int index = -1;
        //searches eachindex of the array until it reaches the last index
